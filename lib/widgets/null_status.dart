...
class DataEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.data);
}
...
class LogEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.logs);
}
...
class ProxyEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.proxies);
}
...
class ProfileEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.profile);
}
...
class ScriptEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.scripts);
}
...
class RuleEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.rules);
}
...
class ConnectionEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.connections);
}
...
class AccessEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.apps);
}
...
class SearchEmptyIllustration extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _EmptyIllustration(type: NullStatusIllustration.search);
}
