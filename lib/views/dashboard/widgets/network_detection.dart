...
class _SharpSolidCirclePainter extends CustomPainter {
  final Color color;
  final double diameter;

  const _SharpSolidCirclePainter({
    required this.color,
  ...
  @override
  bool shouldRepaint(covariant _SharpSolidCirclePainter oldDelegate) =>
...
class _CountryFlagIcon extends StatelessWidget {
  ...
  // 1. 底置黑色实心圆外径 17.5dp，国旗直径 15.1dp 居中置顶覆盖：
  //    - 100% 杜绝国旗内部任何徽标、星徽、图案被黑色描边遮挡或侵占；
  //    - 底置实心黑圆在国旗边缘严丝合缝衬托并自然外延 1.2dp 黑边，在各平台与 DPI 缩放下绝对 0 缝隙、0 白边；
  // 2. 独立纯净矢量 Painter 硬件抗锯齿填充，边缘如原生 Icon 般极致锐利纯净；
  // 3. 外层总宽 21.5dp (左右各留 2.0dp 边距)，高度 24.0dp，与标准 24dp Material Icon 视觉边缘严格对齐。
  static const double _totalDiameter = 17.5;
  static const double _flagDiameter = 15.1;
          ...
          child: Stack(
            ...
            children: [
              CustomPaint(
                ...
                painter: _SharpSolidCirclePainter(
                  color: borderColor,
