...
class _CountryFlagIcon extends StatelessWidget {
  ...
  // 1. 整体最外径锁定 17.6dp，外包边线宽 1.3dp；
  // 2. 纯净独立矢量 Stroke 硬件绘制：直接对齐 NTP 时钟外圈描边（去除了分针与时针后的纯净外圆环），线条如原生 Icon 般极致锐利纯净；
  // 3. 国旗全幅 17.6dp 填满圆形视口，1.3dp 锐利黑边居上闭合压紧边缘，重叠包裹封死抗锯齿，在任何系统与缩放下绝对 0 缝隙、0 白边；
